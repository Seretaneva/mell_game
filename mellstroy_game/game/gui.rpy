...
init python:
    # --- PALETĂ ---
    gui.bg = "#0d0f12"              # fundal general foarte închis
    gui.neon = "#00d1ff"            # accent (cyan electric)
    gui.neon_hover = "#79ecff"
    gui.neon_dim = "#00d1ff22"      # pentru glow subtil
    gui.text_main = "#ffffff"
    gui.text_dim  = "#b9c1c9"

    # Aplică rapid pe schemele existente
    gui.accent_color = gui.neon
    gui.idle_color = gui.text_dim
    gui.idle_small_color = "#a7b1bb"
    gui.hover_color = gui.neon_hover
    gui.selected_color = gui.text_main
    gui.insensitive_color = "#9aa3ad7f"

    gui.text_color = gui.text_main
    gui.interface_text_color = gui.text_main

    # --- FONTURI ---
    # Pune un font cu Cyrillic în /game/fonts/
    gui.text_font = "fonts/NotoSans-SemiBold.ttf"
    ...
    # --- SLOT-URI SAVE ---
    gui.slot_button_width = 432
    gui.slot_button_height = 308
    gui.slot_button_text_size = 22

    # --- HISTORY ---
    gui.history_height = 220
    gui.history_text_width = 1120
...
define gui.interface_text_font = "cyrillic-old.otf"
...
define gui.title_text_size = 155
