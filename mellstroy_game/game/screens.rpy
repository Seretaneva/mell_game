...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Быстрая сохр.") action QuickSave()
...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Главное Mеню") action MainMenu()
                ...
                hbox:
                    ...
                    if config.has_sync:
                        if CurrentScreenName() == "save":
                            textbutton _("Загрузить в облако"):
                                action UploadSync()
                                xalign 0.5
                        else:
                            textbutton _("Скачать из облака"):
                                action DownloadSync()
                                xalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Время авто-пролистывания")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Переходит к следующей реплике и активирует интерфейс.")

    hbox:
        label _("Пробел")
        text _("Переходит к следующей реплике без выбора вариантов.")
    ...
    hbox:
        label _("Ctrl")
        text _("Пропускает диалоги, пока клавиша удерживается.")

    hbox:
        label _("Tab")
        text _("Переключает режим пропуска диалогов.")

    hbox:
        label _("Page Up")
        text _("Возврат к предыдущему диалогу.")

    hbox:
        label _("Page Down")
        text _("Переход к следующему диалогу.")
    ...
    hbox:
        label "V"
        text _("Включает функцию озвучивания текста.")
...
screen mouse_help():
    ...
    hbox:
        label _("Прокрутка вверх")
        text _("Возврат к предыдущему диалогу.")

    hbox:
        label _("Прокрутка вниз")
        text _("Переход к следующему диалогу.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Start, Guide, B/Правая кнопка")
        text _("Открывает игровое меню.")
